...
# THIS IS THE DIR TO SERVE THE STATIC FILES BY NGINX
STATIC_ROOT = os.environ.get("STATIC_ROOT") if os.environ.get("STATIC_ROOT") else ""

MEDIA_URL = "djangoapp/media/"

# THIS IS DIR WHERE MEDIA FILES ARE UPLOADED
